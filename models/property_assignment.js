...
PropertyAssignment.findByIdAndUpdate = (
  ...
  dbConn.query(
    "UPDATE tbl_property_to_user SET user_to_property_id=?, user_id=?, property_id=? WHERE user_to_property_id=?",
    [
